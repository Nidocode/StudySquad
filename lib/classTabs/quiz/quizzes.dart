...
class _QuizScreenState extends State<QuizScreen> {
  ...
  void pickAnswer( int indexValue){ // the index of the option that we have chosen
  ...
  void goToNextQuestion(){ // method to go to the next question
  ...
  Widget build(BuildContext context) {
    final question = questions[questionIndex];
    bool isLastQ = questionIndex == questions.length - 1; // to check if the Question is the last one or not
    return Scaffold(
      body: Padding(
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                return GestureDetector(
                  onTap: selectedCurrentAnswerIndex == null // (meaning if the user hasn't selected an answer yet)
                  ? () => pickAnswer(index)
              ...
              ? SizedBox(
                ...
                child: ElevatedButton( // if it the last question navigate to the result screen  
                      style: const ButtonStyle(
                            backgroundColor: MaterialStatePropertyAll<Color>(Color.fromRGBO(54, 174, 226, 0.992)),
                            ),
                      onPressed: () {
              ...
              : SizedBox(
                ...
                child: ElevatedButton(
                      style: const ButtonStyle(
                            backgroundColor: MaterialStatePropertyAll<Color>(Color.fromRGBO(54, 174, 226, 0.992)),),
                      onPressed:
                          selectedCurrentAnswerIndex != null ? goToNextQuestion : null,
